...
const CreateBackdatedFT = () => {
  ...
  // Fetch accounts and set defaults
  useEffect(() => {
    ...
    // Auto‑generate reference (BFT‑XXXXXX)
    const ref = `BFT-${String(Math.floor(Math.random() * 1000000)).padStart(6, '0')}`;
    const user = JSON.parse(localStorage.getItem('user') || '{}');
    setForm((prev) => ({
      ...prev,
      reference: ref,
      createdBy: user?.name || user?.username || 'Accountant',
    }));
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Backdated Transfer Data:', form);
    toast.success('Backdated transfer submitted (demo)');
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          >
            Create Backdated Fund Transfer
          </h2>
          <div
            style={{
              height: '4px',
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <div>
              <label style={labelStyle}>Transaction Date (Past Date)</label>
              <input
                type="date"
          ...
          <div style={{ marginBottom: '24px' }}>
            <label style={labelStyle}>Reason for Backdating</label>
            <textarea
              name="reason"
              rows="2"
              placeholder="e.g., Late recording of transfer"
              value={form.reason}
              onChange={handleChange}
              style={{
                ...inputStyle,
          ...
          >
            <div>
              <label style={labelStyle}>Approval Required</label>
              <select
                name="approvalStatus"
