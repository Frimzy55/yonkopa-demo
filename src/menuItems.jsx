export const menuItems = [
  ...
  },
  {
    ...
    subMenus: [
      ...
      // In the Loans section of menuItems
      {
        name: "Web Loan",
        icon: "bi-globe",
        nestedMenus: [
            { name: "Client's Web Loan", icon: 'bi-person' },
            { name: "Officer's Web Loan", icon: 'bi-person-badge' }
        ],
      },
    ...
    subMenus: [
      ...
      },
      {
        ...
        nestedMenus: [
          ...
          {
            name: "Approve Backdated Till Transfer",
            icon: "bi-calendar-minus",
          },
          {
            name: "Approve Cash Deposit Reversal",
            icon: "bi-arrow-return-left",
          },
          {
            name: "Approve Cash Withdrawal Reversal",
            icon: "bi-arrow-return-right",
          },
          {
            name: "Approve Teller Shortage & Overage",
            icon: "bi-exclamation-triangle",
          },
          { name: "Approve Backdated deposit", icon: "bi-arrow-return-right" },
          {
            name: "Approve Backdated withdrawals",
            icon: "bi-exclamation-triangle",
          },
        ],
      },
      {
        ...
        nestedMenus: [
          ...
          {
            name: "Approve Manual GL Postings",
    ...
    subMenus: [
      ...
      },
      {
        ...
        reports: [
          ...
          {
            name: "Expected vs Actual Collections",
